...
%description
viewglob is a utility designed to extend bash and zsh when used in windowing environments.  It tracks changes in the command line as they are typed and reveals file selections and globbing in a GTK+ display showing the layout of relevant directories.
